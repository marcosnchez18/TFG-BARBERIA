...
export default function DatosTrabajador({ trabajador }) {
    ...
    const savePhotoChange = () => {
        ...
        Inertia.post(route('trabajador.actualizar-foto', trabajador.id), formData, {
            onSuccess: (response) => {
                ...
                setPhotoPreview(`/storage/${response.props.trabajador.imagen}`);
            },
            onError: () => {
    ...
    return (
        <div className="bg-white p-10 rounded-lg shadow-lg max-w-4xl w-full border border-gray-200">
